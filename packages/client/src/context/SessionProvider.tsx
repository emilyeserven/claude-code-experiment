...
export function SessionProvider({
  ...
  const updateEntry = useCallback((index: number, entry: TimerEntry) => {
    setSessions(prev => prev.map(s =>
      s.id === activeSessionId
        ? {
          ...s,
  ...
  const value = useMemo(() => ({
    ...
    deleteEntry,
    deleteEntries,
  }), [sessions, activeSession, createSession, deleteSession, renameSession, switchSession, addEntry, updateEntry, deleteEntry, deleteEntries]);
