...
test.describe("Settings and dark mode", () => {
  ...
  test("opens the settings popover when clicking the settings button", async ({ page }) => {
    await page.getByTestId("settings-trigger").click();
    await expect(page.getByText("Settings").first()).toBeVisible();
    await expect(page.getByText("Dark Mode")).toBeVisible();
  });

  test("toggles dark mode on", async ({ page }) => {
    await page.getByTestId("settings-trigger").click();
  ...
  test("toggles dark mode off after enabling it", async ({ page }) => {
    await page.getByTestId("settings-trigger").click();
  ...
  test("dark mode toggle button label changes between Dark and Light", async ({ page }) => {
    await page.getByTestId("settings-trigger").click();
  ...
  test("dark mode preference is stored in localStorage", async ({ page }) => {
    await page.getByTestId("settings-trigger").click();
    await page.getByTestId("dark-mode-toggle").click();
