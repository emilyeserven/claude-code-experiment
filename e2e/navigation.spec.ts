...
test.describe("Navigation", () => {
  test("renders the navigation bar with Home and About links", async ({ page }) => {
    await page.goto("/");
  ...
  test("Home link is active on the home page", async ({ page }) => {
    await page.goto("/");
  ...
  test("settings button is visible in the navigation bar", async ({ page }) => {
    await page.goto("/");
